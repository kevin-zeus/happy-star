...
class ProductApi extends BaseApi {
  ...
  // ]
  create({
    product_name, product_image, product_category_id, price, status, description, rule,
  }) {
  ...
  update({
    product_id, product_name, product_image, product_category_id, price, status, description, rule,
  }) {
